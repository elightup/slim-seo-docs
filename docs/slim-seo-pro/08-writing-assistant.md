...
The **Writing Assistant** analyzes your content in real time to help you create SEO-optimized posts and pages. It gives instant feedback on keywords, readability, content structure, and media optimization. It helps you improve quality and search engine rankings.

## Where to Find It

If you use **Slim SEO Free**, you will see the **Writing Assistant** tab in the **Search Engine Optimization** meta box when editing a post or page:

![Writing assistant tab with Slim SEO](img/writing-assistant-with-slim-seo.png)

If you do not use **Slim SEO Free**, you will see the **Writing Assistant** meta box instead:

![Writing assistant tab without Slim SEO](img/writing-assistant-without-slim-seo.png)

:::info
You can use [Slim SEO Pro](https://wpslimseo.com/products/slim-seo-pro/) with or without Slim SEO Free.
...
The Writing Assistant offers suggestions to help you improve your content. These are **opinionated recommendations**, not strict rules you must follow. Think of it as an assistant that gives feedback to enhance your writing.
...
- **Keyword density**: Counts how often and how many times a keyword appears. A density between **0.5% and 3%** is recommended. Lower values mean the keyword may not be a topic of the article. Higher values may appear spammy.
- **Keyword placement**: Checks if the keyword appears in the title, slug, excerpt, intro paragraph, headings, and image alt text. These locations signal your topic to readers and search engines.
...
Keyword inclusion in slugs is already checked in the **Keywords** section.
...
Now you are ready to create content that is both useful and optimized for SEO.
