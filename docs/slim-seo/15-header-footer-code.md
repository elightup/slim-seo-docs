...
- For header code, your theme must implement the `wp_head()` function in the `header.php` file.
- For body code, your theme must implement the `wp_body_open()` function in the `header.php` file.
- For footer code, your theme must implement the `wp_footer()` function in the `footer.php` file.
